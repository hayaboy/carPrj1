...
def insert_db():
    ...
    try:
        with engine.connect() as conn:
            ...
            df_company.to_sql('company', con=engine, index=False,
                              if_exists="append", method="multi")
            df_year2019.to_sql('year2019', con=engine,
                               index=False, if_exists="append", method="multi")
            df_year2020.to_sql('year2020', con=engine,
                               index=False, if_exists="append", method="multi")
            df_year2021.to_sql('year2021', con=engine,
                               index=False, if_exists="append", method="multi")
            df_year2022.to_sql('year2022', con=engine,
                               index=False, if_exists="append", method="multi")
            df_year2023.to_sql('year2023', con=engine,
                               index=False, if_exists="append", method="multi")
            df_faq.to_sql('faq', con=engine, index=False,
                          if_exists="append", method="multi")
            df_car.to_sql('car', con=engine, index=False,
                          if_exists="append", method="multi")
